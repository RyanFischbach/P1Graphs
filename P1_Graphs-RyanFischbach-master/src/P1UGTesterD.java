...
public class P1UGTesterD 
{
	public static void main (String [] args)
	{
		...
		System.out.println("\n=== PROJECT 1 : UNDIRECTED GRAPH TESTER for BLOCK D ===");
		...
		if ( path != null )
		{
			...
			if ( path.size()>=7 && (!path.get(6).equals("Barstow") || !path.get(5).equals("Bakersfield") || !path.get(2).equals("Merced")))
			{
		...
		if ( path != null )
		{
			...
			if (path.size()>=7 && (!path.get(2).equals("Barstow") || !path.get(3).equals("Bakersfield") || !path.get(6).equals("Merced")))
			{
				System.out.println("   FAILED! wrong path.");
